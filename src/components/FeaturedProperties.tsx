...
const properties = [
  {
    ...
    type: "Industrial",
    price: "$3,450,000",
    detail: "24,600 SF · 28' Clear",
    sqft: "24,600",
    address: "1842 W Industrial Pkwy, West Valley City, UT 84120",
  },
  {
    image: listing2,
    status: "For Lease",
    type: "Office",
    price: "$28/SF NNN",
    detail: "Class A · 8,200 SF Available",
    sqft: "8,200",
    address: "562 N Commerce Dr, Sandy, UT 84070",
  },
  {
    image: listing3,
    status: "For Sale",
    type: "Land",
    price: "$1,895,000",
    detail: "5.4 Acres · Highway Frontage",
    sqft: "235,224",
    address: "3208 S Bangerter Hwy, Bluffdale, UT 84065",
  },
];
